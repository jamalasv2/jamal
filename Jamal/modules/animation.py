...
@PY.UBOT("terkadang")
async def terkadang(_, m: Message):
    typew = await edit_or_reply(
        m, "`Terkadang`")
    sleep(1)
...
async def cinta(_, m):
    ...
    for i in animation_ttl:
        ...
        await m.edit(animation_chars[i % 11])
...
@PY.UBOT("ngocok")
async def ngocok(_, m: Message):
  typew = await edit_or_reply(
    m, "`<b>KOCOKIN SAYANGG🥵🥵🥵</b>`")
  sleep(3)
  ...
  await typew.edit("`8✊===D💦💦💦💦💦💦💦💦💦💦`")
  sleep(2)
  await typew.edit("`<b>AHHH ENAKKK SAYANGGG🤤🤤</b>`")
...
<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ:<code>{0}gabut</code>|<code>{0}dino</code>|<code>{0}awk</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ:<code>{0}cinta</code>|<code>{0}gombal</code>|<code>{0}sayang</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: <code>{0}terkadang</code> | <code>{0}y</code> | <code>{0}santet</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: {0}helikopter</code> | <code>{0}tank</code> | <code>{0}tembak</BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: <code>{0}bernyanyi</code>|<code>{0}ngocok</code> | <code>{0}bundir</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: <code>{0}ular</code> | <code>{0}babi</code> | <code>{0}ajg</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: <code>{0}huh</code> | <code>{0}hua</code> | <code>monyet</code></BLOCKQUOTE>

<BLOCKQUOTE>❏ ᴘᴇʀɪɴᴛᴀʜ: <code>{0}ceritacinta</code> | <code>{0}canda</BLOCKQUOTE>
